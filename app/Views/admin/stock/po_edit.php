...
<script>
	...
	<td>
	<input type="number" class="form-control price" value="${price}" step="0.01">
	</td>
	...
	alert("PO Updated: " + data.po_number);
	...
	poItems.forEach(i=>{
	addRow(i.product_id,i.qty_ordered,i.cost_price);
	});
